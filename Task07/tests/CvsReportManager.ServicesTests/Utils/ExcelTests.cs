...
namespace CvsReportManager.Services.Utils.Tests
{
    ...
    public class ExcelTests
    {
        ...
        /// <param name="fileName">File name.</param>
        /// <param name="seporator">Seporator between words.</param>
        [TestCase("60,8333333333333", "ExcelTestsWithDouble", ';')]
        public void GivenPrint_WhenInExcelTestsWithDouble_ThenOutIsXlsxFile(string actual, string fileName, char seporator)
        {
            //Arrange
            Excel excel = new Excel(directoryInfoFullName, fileName);
            //Act
